...
$string['ggbfilemissing'] = 'Falta la cadena de caracteres en base64 en la respuesta. Probablemente JavaScript no se encuentra activado en el navegador o haya surgido un error desconocido';
...
$string['noappletloaded'] = '¡Ningún applet cargado! Compruebe que la URL sea correcta y que un enlace conduzca a un applet';
